...
-- This will create the notes table and all necessary functions
...
-- Insert a sample note to test
INSERT INTO public.notes (title, content, public, slug, category, emoji) 
VALUES (
